/* Готовый персонаж: Шмолд Молд, моцлинг-род-класс 2 уровня.
...
(function () {
  ...
  function build() {
    ...
    var ch = {
      ...
      kindred: { id: 'mossling', ru: 'Моцлинг', en: 'Mossling', type: 'mortal', typeRu: 'Смертный', size: 'Small', sizeRu: 'Малый', page: 48 },
      profile: {
      ...
      validation: [
        {
          ...
          book: 'Рок 8, Луч 9, Захват 10, Взрыв 13, Заклинание 12 — таблица развития моцлинга-род-класса, 2 уровень',
          note: 'Книжные значения ЛУЧШЕ (чем меньше — тем лучше), поэтому я НЕ стал их подставлять: это было бы тихим усилением персонажа. Оставил числа с твоего листа. Спроси у ГМ, по какой таблице считаем — возможно, на VTT моцлинг сделан как род плюс отдельный класс.'
        },
        {
        ...
        },
        {
          ...
          book: '610 на себе + 83 в рюкзаке + 318 монет = 1011. Свыше 800 → Скорость 10; 10×3 = 30 футов за ход; 10÷5 = 2 очка пути. 2 уровень моцлинга наступает на 2200 XP, третий — на 4400'
        },
        {
          ...
          book: 'Таблица безделушек моцлинга, d100 47–48; таблица Симбиотической плоти, d20 = 19'
        }
      ],
  ...
  DW.PRESETS.shmold = { id: 'dw_shmold_mould', title: 'Шмолд Молд — моцлинг, 2 уровень', build: build };
})();
