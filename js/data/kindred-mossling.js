/* Моцлинг — Mossling. Player's Book, стр. 48–51 (род), 186–187 (род-класс). */
(function () {
  'use strict';
  var tbl = DW.tbl, names = DW.names, d100 = DW.d100pairs;

  DW.KINDREDS = DW.KINDREDS || {};
  DW.KINDREDS.mossling = {
    id: 'mossling',
    ru: 'Моцлинг', en: 'Mossling',
    ...
    lore: 'Моцлинги — малоизвестный низкорослый народ, коренной для Дольменвуда, сроднившийся с сырыми растениями и плесенью глухих чащ. Приземистые и пухлые, с зелёной, жёлтой или бурой кожей, текстурой как морщинистая кора, покрытой плесенью, лишайником, грибами и ползучими растениями. Волосы и бороды зелёные или чёрные, растительные. Раненый моцлинг сочится белым древесным соком. С возрастом становятся мудрее и всё больше похожи на растения; после смерти тело за год перегнивает в богатый компост. Живут в тёмных сырых лесах, роя норы. Формально прихожане Церкви, но на деле чтят своих богов глубокого леса и плодородного подземья (Могба).',
    relations: 'В добрых отношениях со смертными и полуфейскими родами. К феям относятся с любопытством — как к странникам издалека с интересными байками. В людских поселениях моцлингов охотно принимают: они приходят продавать грибы, эль или сыр на рынок.',
    classAdvice: 'Моцлинги чаще всего воины и охотники. Изредка их принимают в рыцари, редко идут в Церковь клириками или монахами, и почти никогда не имеют достаточно связи с Фейри для чароплёта.',

    traits: [
      { ru: 'Броня и оружие', en: 'Armour and Weapons', p: 49,
        d: 'Броню нужно подгонять под малый размер. Большое (Large) оружие недоступно. Моцлинги предпочитают неметаллическую броню и делают доспехи из закалённой коры и сосновых шишек. Если при генерации выпала кольчуга — заменяется корьевой бронёй; латы — сосновой бронёй.' },
      { ru: 'Сноровки', en: 'Knacks', p: 49,
        d: 'Моцлинги практикуют тщательно оберегаемые полумагические ремёсла — сноровки. Каждый моцлинг знает одну, выбранную или выброшенную при создании персонажа.' },
      { ru: 'Навыки моцлинга', en: 'Mossling Skills', p: 49,
        d: 'Цель навыка Выживание при собирательстве — 5.' },
      { ru: 'Стойкость', en: 'Resilience', p: 49,
        d: 'Моцлинги крепки, как узловатый ствол старого дерева: +4 к спасброскам против грибных спор и ядов и +2 ко всем остальным спасброскам.' },
      { ru: 'Симбиотическая плоть', en: 'Symbiotic Flesh', p: 49,
        d: 'С возрастом сырая плодородная плоть моцлинга подхватывает семена и споры, которые прорастают в симбиотические растения и грибы. На каждом уровне (включая 1-й) персонаж получает случайную черту из таблицы Симбиотической плоти. Повторы можно перебросить или взять как усиление черты.' }
    ],
...
`),
    ...
    kindredClass: {
      ru: 'Моцлинг (род-класс)', en: 'Mossling Kindred-Class',
      ...
      desc: 'Моцлинги-искатели приключений умеют много полезного вокруг грибов и владеют малыми магическими талантами — сноровками.',
      startArmour: [
        { r: [1, 1], items: ['leather'] },
      ...
      traits: [
        { ru: 'Броня', en: 'Armour', d: 'Броню нужно подгонять под малый размер. Моцлинги предпочитают неметаллическую броню — из закалённой коры и сосновых шишек.' },
        { ru: 'Навыки моцлинга', en: 'Mossling Skills', d: 'Выживание при собирательстве — цель 5.' },
        ...
        { ru: 'Грибной симбиоз (с 4 ур.)', en: 'Fungal Symbiosis (from Level 4)', d: 'С 4 уровня моцлинг может за 1 ход попытаться заключить симбиоз с невраждебным чудовищным грибом (уровнем минимум на 3 ниже своего), получив возможность применять его особые силы.' }
      ],
      advancement: [
...
`),
    namesNote: 'Среди своих моцлинги обычно не пользуются фамилиями. Если чужаки настаивают, берут смесь волдийских слов, связанных с их культурой.',
