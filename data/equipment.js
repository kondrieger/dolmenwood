...
export const SHIELD = { id: 'shield', ru: 'Щит', en: 'Shield', cost: 10, acBonus: 1, weight: 100, slots: 1 };
...
/* ======================= НАГРУЗКА ПО ВЕСУ — стр. 148 =======================
   Основная система в нашей игре (её же использует VTT-лист: поле Load x / 1600).
   Вес считается в монетах: 10 монет = 1 фунт. Максимальная переносимая нагрузка — 1600. */
export const WEIGHT_ENCUMBRANCE = [
  { maxWeight: 400,  speed: 40 },
  { maxWeight: 600,  speed: 30 },
  { maxWeight: 800,  speed: 20 },
  { maxWeight: 1600, speed: 10 }
];
export const MAX_LOAD = 1600;

/* Домашние правила нашего Рефери: эти вещи в инвентарь и в вес не идут. */
export const LOAD_EXEMPT_IDS = ['beltpouch'];
export const LOAD_EXEMPT_CATS = ['clothing'];

/* ======================= НАГРУЗКА (слоты) — стр. 149, необязательная ======================= */
export const SLOT_ENCUMBRANCE = [
