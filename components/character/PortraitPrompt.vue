...
<template>
  <div class="card">
    ...
    <p class="muted" style="margin-top: -4px">
      ...
      Текст собирается из рода, класса и уровня, всех выпавших примет, магии, безделушки, прошлого,
      лунного знака и настоящего носимого снаряжения — меняешь лист, меняется и промпт.
      Палитра, свет и композиция выбираются по идентификатору персонажа: у одного героя они всегда
      одни и те же, а у двух разных — разные.
    </p>
